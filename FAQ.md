...
1. How do I help fix a typo or other minor documentation change?
  - Navigate to the file on the [repo](https://github.com/yihui/knitr)
  - Click on the **edit** button
  - Make the changes
  - Save the changes. Please include a commit summary.
  - Click on the **pull request** button and follow the prompts.
